...
const products = [
    {
        ...
        img: `${imgSerum}`,
        stock: 10,
        description: 'Para piel con tendencia al acné, tratamiento concentrado (Ácido Salicílico + Vitamina C + AHA).'
    },
    {
        id: '2',
        ...
        img:  `${imgRevitalif}`,
        stock: 2,
        description: '1.5% Con ácido hialurónico micro y macro + 1% cafeína. Elimina líneas de expresión.'
    },
    {
        id: '3',
        ...
        img:  `${imgLipstick}`,
        stock: 2,
        description: 'Lipsticks con tonos edicion limitada, en un empaque coleccionable que presenta a los Kakao Friends.'
    },
    {
        id: '4',
